...
public class cityScape extends BasicLevel {
  ...
  public cityScape(BaseGame game, InputHandler handler) {
    ...
    terrain =
        new Terrain(new RGBImage(GameState.getInstance().getSelectedLevelTerrain()).getRgbBufferedImage(),
                    ResourceManager.getBackGround());
  ...
  public void onDraw(Renderer renderer) {
    ...
    renderer.DrawPixelArrayRGB(ResourceManager.getTerrain().getScreenPixels(), 0, 0, GameState.getInstance().getWidth(),
                               GameState.getInstance().getHeight());
