...
public class MenuLevelButton extends Button {
  ...
  public MenuLevelButton(final File lvl, final MenuLevelSelect menuLevelSelect) {
    ...
    lvlTerrain =
        new File(lvl.getAbsolutePath().split("_")[lvl.getAbsolutePath().split("_").length - 2] + "_terrain.png");
    lvlBackground =
        new File(lvl.getAbsolutePath().split("_")[lvl.getAbsolutePath().split("_").length - 2] + "_background.png");
